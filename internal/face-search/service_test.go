...
// 		saveProgressResult := search.Result{
// 			Status:    search.InProccess,
// 			UUID:      testUUID,
// 			PhotoHash: testFileHash,
// 			CreateAt:  testTimestamp,
// 		}
// 		m.On("Save", saveProgressResult).
// 			Return(errNilTest)
...
// 		updateProgressResult := search.Result{
// 			Status:    search.InProccess,
// 			Error:     errTest.Error(),
// 			UUID:      testUUID,
// 			PhotoHash: testFileHash,
...
// 			UpdateAt:  testTimestamp,
// 		}
// 		m.On("Update", updateProgressResult).
// 			Return(errNilTest)
// 		successResult := search.Result{
// 			Status:    search.Success,
// 			UUID:      testUUID,
// 			PhotoHash: testFileHash,
// 			Profiles:  testProfiles,
